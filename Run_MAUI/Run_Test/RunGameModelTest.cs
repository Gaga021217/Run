...
namespace Run_Test {
    ...
    public class RunGameModelTest {
        ...
        public void RunGameModelNewGameMediumMediumTest() {
            _model.GameDifficulty = GameDifficulty.Intermediate;
            _model.GameSize = 15;
            _model.NewGame();


            Assert.AreEqual(0, _model.GameStepCount);
            Assert.AreEqual(GameDifficulty.Intermediate, _model.GameDifficulty);
            Assert.AreEqual(0, _model.GameTime);
        ...
        public void RunGameModelMovementTest() {
            ...
            Tuple<int, int> player = _model.Table.PlayerLocation();
            _model.MovePlayer("W");
