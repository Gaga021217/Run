...
namespace Run.Persistence {
    ...
    public class RunTable {
        ...
        public FieldValue this[Int32 x, Int32 y] { get { return GetValue(x, y); } }
        ...
        public RunTable(Int32 tableSize) {
            if (tableSize < 0)
        ...
        public Boolean IsChaser(Int32 x, Int32 y) {
            if (x < 0 || x >= Size)
        ...
        public Boolean IsBomb(Int32 x, Int32 y) {
            if (x < 0 || x >= Size)
                throw new ArgumentOutOfRangeException(nameof(x), "The X coordinate is out of range.");
            if (y < 0 || y >= Size)
                throw new ArgumentOutOfRangeException(nameof(y), "The Y coordinate is out of range.");
        ...
        public Boolean IsPlayer(Int32 x, Int32 y) {
            if (x < 0 || x >= Size)
                throw new ArgumentOutOfRangeException(nameof(x), "The X coordinate is out of range.");
            if (y < 0 || y >= Size)
                throw new ArgumentOutOfRangeException(nameof(y), "The Y coordinate is out of range.");
        ...
        public FieldValue GetValue(Int32 x, Int32 y) {
            if (x < 0 || x >= Size)
                throw new ArgumentOutOfRangeException(nameof(x), "The X coordinate is out of range.");
            if (y < 0 || y >= Size)
                throw new ArgumentOutOfRangeException(nameof(y), "The Y coordinate is out of range.");
        ...
        public void SetValue(Int32 x, Int32 y, FieldValue value) {
            if (x < 0 || x >= Size)
                throw new ArgumentOutOfRangeException(nameof(x), "The X coordinate is out of range.");
            if (y < 0 || y >= Size)
                throw new ArgumentOutOfRangeException(nameof(y), "The Y coordinate is out of range.");
        ...
        public Tuple<Int32, Int32> PlayerLocation() {
            for (int i = 0; i < Size; i++) {
                for (int j = 0; j < Size; j++) {
                    if (IsPlayer(i, j)) {
                        return new Tuple<Int32, Int32>(i, j);
                    }
                }
            }
        ...
        public List<Tuple<Int32, Int32>> ChaserLocations() {
            List<Tuple<Int32, Int32>> result = new List<Tuple<int, int>>();
            for (int i = 0; i < Size; i++) {
                for (int j = 0; j < Size; j++) {
                    if (_fieldValues[i, j] == FieldValue.Chaser) {
                        result.Add(new Tuple<Int32, Int32>(i, j));
                    }
                }
        ...
        public Boolean MoveLeft(Int32 x, Int32 y) {
            if (x - 1 < 0 || x >= Size)
                return false;
            if (y < 0 || y >= Size)
                return false;
        ...
        /// <param name="y">Vertical coordinate.</param>
        /// <returns>True, if the movement was successful, false otherwise.</returns>
        public Boolean MoveRight(Int32 x, Int32 y) {
            if (x < 0 || x + 1 >= Size)
                return false;
            if (y < 0 || y >= Size)
                throw new ArgumentOutOfRangeException(nameof(y), "The Y coordinate is out of range.");
        ...
        /// <param name="y">Vertical coordinate.</param>
        /// <returns>True, if the movement was successful, false otherwise.</returns>
        public Boolean MoveUp(Int32 x, Int32 y) {
            if (x < 0 || x >= Size)
                return false;
            if (y - 1 < 0 || y >= Size)
                return false;
        ...
        /// <param name="y">Vertical coordinate.</param>
        /// <returns>True, if the movement was successful, false otherwise.</returns>
        public Boolean MoveDown(Int32 x, Int32 y) {
            if (x < 0 || x >= Size)
                return false;
            if (y < 0 || y + 1 >= Size)
                return false;
